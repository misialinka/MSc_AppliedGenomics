...
#load the csv files with results of the DESeq2 analysis - output of DESEQ2 includes log2 fold changes in gene expression. I am uploading lists for adenomas vs paired normal tissue (res_adenoma), serrated vs paired normal tissue (res_serrated), and comparison of serrated vs adenomas (res_comparison)
...
#for GSEA analysis create a list including fold changes sorted in decreasing order and gene_ids. Make sure that the are no duplicates in gene names ---------
##for res_adenoma 
...
#extract gene sets from MSigDb. Database H includes cancer hallmarks gene sets. Extract the gene names from the same category that you have in the gene lists. Database C2 includes KEGG gene sets, which can be filtered ---------
...
#conducting GSEA using hallmarks of cancer on adenomas, serrated polyps and comparison between them ------
#hallmarks GSEA for ade vs normal
set.seed(97)
...
#hallmarks GSEA for serrated vs normal
set.seed(256)
...
#hallmarks GSEA for normal to serrated vs polyp 
...
#selecting data neccessary to create a shared doplot for serrated and adenomas 
...
#plotting the significantly enriched hallmark pathways in adenomas, serrated polyps, and their comparisons
...
#extracting pathways of interest for enrichment analysis from KEGG database --------
...
#GSEA for antigen processing for serrated lesions 
...
#GSEA for antigen processing for serrated vs adenoma lesions 
...
#making a single dotplot for adenomas, serrated polyps and their comparion for GSEA for antigen processing
...
#verifying GSEA for PDL1/PD and CTLA4 (immune checkpoint) signalling from KEGG databases-------
icb_t2g <- KEGG_t2g |>
  filter(gs_name == "CD80 CD86 CTLA4 PP2A SIGNALING PATHWAY" | gs_name == "PDL PD1 SHP PI3K SIGNALING PATHWAY")

#GSEA for PDL1/PD and CTLA4 signalling for adenomas
...
#GSEA for PDL1/PD and CTLA4 signalling for serrated lesions 
...
#GSEA for PDL1/PD and CTLA4 signalling for serrated vs adenoma lesions 
...
#making a single dotplot for adenomas, serrated polyps and their comparion for GSEA for PDL1/PD and CTLA4 signalling
